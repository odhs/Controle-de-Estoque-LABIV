...
public class SaidaDataPanel extends JPanel{
	...
	public SaidaDataPanel(Saida saida, Integer modificador) {
	...
	public JTextField getQtdField(){
		if(qtdField == null){
			...
			if(modificador == Modificadores.FRAMESAIDAS)
				qtdField.setText(saida.getQuantidade());
	...
	public JComboBox<?> getFornecedorCombo(){
		if(fornecedorCombo == null){
			...
			if(modificador == Modificadores.FRAMESAIDAS)
				fornecedorCombo.setSelectedItem(new DAO().getFornecedorName2(saida));
		}
	...
	public JCalendar getCalendar(){
		if(calendar == null){
			...
			if(modificador == Modificadores.FRAMESAIDAS)
				calendar.setSelectedItemString(saida.getData());
	...
	public JTextField getProdutoField(){
		if(produtoField == null){
			...
			if(modificador == Modificadores.FRAMESAIDAS){
				produtoField.setText(new DAO().getProdutoName2(saida));
			}
